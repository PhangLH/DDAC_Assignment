<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateNewContainer.aspx.cs" Inherits="DDAC_Assignment.Admin.CreateNewContainer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="tboxSize" CssClass="col-md-2 control-label">Max Weight(KG)</asp:Label>
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="tboxSize" CssClass="form-control" />
                <asp:RequiredFieldValidator runat="server" ControlToValidate="tboxSize" 
                    CssClass="text-danger" Display="Dynamic" ErrorMessage="The weight field is required" />
                <asp:RegularExpressionValidator ID="regexNumber" runat="server" ControlToValidate="tboxSize" CssClass="text-danger"
                    ErrorMessage="Please Enter Only Numbers" Display="Dynamic" ValidationExpression="^\d+$"></asp:RegularExpressionValidator>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" OnClick="CreateContainer_Click" Text="Register" CssClass="btn btn-default" />
            </div>
        </div>
    </div>
